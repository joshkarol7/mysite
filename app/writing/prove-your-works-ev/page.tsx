  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12 font-[family-name:var(--font-geist-sans)]">
      ...
      <header className="mb-10">
        ...
        <p className="text-xs tracking-widest text-gray-600 dark:text-gray-400">Jan 13, ’25</p>
      </header>
      ...
      <article className="space-y-10 leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            ...
            Bloomberg, my boss did not know what HTTP was because it was too far abstracted from all day-to-day
            code. Abstractions are useful, but blind reliance on them makes you slow and fragile.
          </p>
          <p className="text-gray-600 dark:text-gray-400">
