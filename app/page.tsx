        ...
        <div className="space-y-4">
          <div>
            <div className="mt-1 flex items-baseline gap-3">
              <Link href="/writing/prove-your-works-ev" className="text-blue-600 dark:text-blue-400 hover:underline">
                how we build
              </Link>
              <span className="text-xs tracking-widest text-gray-600 dark:text-gray-400">Jan 13, ’25</span>
            </div>
          </div>
        </div>
      </section>
